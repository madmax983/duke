//! Utilities for analyzing and diffing bytecode changes between two jar files.
...
/// Analyzes two jar files and prints a summary of added, removed, and modified methods.
///
/// # Examples
/// ```no_run
