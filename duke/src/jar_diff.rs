//! Compares the bytecode of two JAR files and reports added, removed, or modified methods.
//!
//! **Why it exists:** Upgrading library versions can introduce silent semantic changes. By comparing every method in two JARs, this module alerts the user to structural modifications, not just file hashes.
