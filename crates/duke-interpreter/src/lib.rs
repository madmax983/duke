...
pub mod registry;
pub use crate::stdlib::bootstrap_stdlib;
pub mod stdlib;
mod threading;

use crate::stdlib::{heap_object_to_string, static_field_idx, THREAD_ID_SLOT, THREAD_TARGET_SLOT};
pub use context::*;
pub use registry::*;
...
mod tests {
        ...
        ($($name:ident),* $(,)?) => {
            $(
                fn $name(
                    ...
                    crate::stdlib::$name(args, heap, out, &mut NativeControl::default())
                }
            )*
        };
    }
    ...
    fn array_list_sort(
        ...
        crate::stdlib::array_list_sort(args, heap, out, &mut NativeControl::default(), invoke)
    }
