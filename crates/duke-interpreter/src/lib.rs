...
pub fn bootstrap_stdlib(registry: &mut ClassRegistry, heap: &mut duke_gc::Heap) {
    ...
    registry.natives_mut().register(
        ...
        "println",
        "(Ljava/lang/String;)V",
        natives::native_println_string,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "println",
        "(I)V",
        natives::native_println_int,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "println",
        "()V",
        natives::native_println_void,
    );
    ...
    registry.natives_mut().register(
        ...
        "<init>",
        "(Ljava/lang/String;)V",
        natives::native_file_init,
    );
    registry
        .natives_mut()
        .register("java/io/File", "exists", "()Z", natives::native_file_exists);
    registry.natives_mut().register(
        "java/io/File",
        "isFile",
        "()Z",
        natives::native_file_is_file,
    );
    registry.natives_mut().register(
        "java/io/File",
        "isDirectory",
        "()Z",
        natives::native_file_is_directory,
    );
    ...
    registry.natives_mut().register(
        ...
        "<init>",
        "(Ljava/lang/String;)V",
        natives::native_file_input_stream_init,
    );
    registry.natives_mut().register(
        "java/io/FileInputStream",
        "read",
        "()I",
        natives::native_file_input_stream_read,
    );
    registry.natives_mut().register(
        "java/io/FileInputStream",
        "read",
        "([B)I",
        natives::native_file_input_stream_read_bytes,
    );
    registry.natives_mut().register(
        "java/io/FileInputStream",
        "close",
        "()V",
        natives::native_file_input_stream_close,
    );
    ...
    registry.natives_mut().register(
        ...
        "<init>",
        "(Ljava/lang/String;)V",
        natives::native_file_output_stream_init,
    );
    registry.natives_mut().register(
        "java/io/FileOutputStream",
        "write",
        "(I)V",
        natives::native_file_output_stream_write,
    );
    registry.natives_mut().register(
        "java/io/FileOutputStream",
        "write",
        "([B)V",
        natives::native_file_output_stream_write_bytes,
    );
    registry.natives_mut().register(
        "java/io/FileOutputStream",
        "close",
        "()V",
        natives::native_file_output_stream_close,
    );
    ...
    registry.natives_mut().register(
        ...
        "<init>",
        "(I)V",
        natives::native_server_socket_init,
    );
    registry.natives_mut().register(
        "java/net/ServerSocket",
        "accept",
        "()Ljava/net/Socket;",
        natives::native_server_socket_accept,
    );
    registry.natives_mut().register(
        "java/net/ServerSocket",
        "getLocalPort",
        "()I",
        natives::native_server_socket_get_local_port,
    );
    registry.natives_mut().register(
        "java/net/ServerSocket",
        "close",
        "()V",
        natives::native_server_socket_close,
    );
    ...
    registry.natives_mut().register(
        ...
        natives::native_socket_init,
    );
    registry.natives_mut().register(
        "java/net/Socket",
        "getInputStream",
        "()Ljava/io/InputStream;",
        natives::native_socket_get_input_stream,
    );
    registry.natives_mut().register(
        "java/net/Socket",
        "getOutputStream",
        "()Ljava/io/OutputStream;",
        natives::native_socket_get_output_stream,
    );
    registry.natives_mut().register(
        "java/net/Socket",
        "close",
        "()V",
        natives::native_socket_close,
    );
    ...
    registry.natives_mut().register(
        ...
        "length",
        "()I",
        natives::native_string_length,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "equals",
        "(Ljava/lang/Object;)Z",
        natives::native_string_equals,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "charAt",
        "(I)C",
        natives::native_string_char_at,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "substring",
        "(I)Ljava/lang/String;",
        natives::native_string_substring,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "substring",
        "(II)Ljava/lang/String;",
        natives::native_string_substring_range,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "indexOf",
        "(Ljava/lang/String;)I",
        natives::native_string_indexof,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "contains",
        "(Ljava/lang/CharSequence;)Z",
        natives::native_string_contains,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "isEmpty",
        "()Z",
        natives::native_string_isempty,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "compareTo",
        "(Ljava/lang/String;)I",
        natives::native_string_compareto,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "compareTo",
        "(Ljava/lang/Object;)I",
        natives::native_string_compareto_object,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "startsWith",
        "(Ljava/lang/String;)Z",
        natives::native_string_startswith,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "endsWith",
        "(Ljava/lang/String;)Z",
        natives::native_string_endswith,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "trim",
        "()Ljava/lang/String;",
        natives::native_string_trim,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "toCharArray",
        "()[C",
        natives::native_string_tochararray,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "toUpperCase",
        "()Ljava/lang/String;",
        natives::native_string_touppercase,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "toLowerCase",
        "()Ljava/lang/String;",
        natives::native_string_tolowercase,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "replace",
        "(CC)Ljava/lang/String;",
        natives::native_string_replace_char,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "replace",
        "(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;",
        natives::native_string_replace_charsequence,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "split",
        "(Ljava/lang/String;)[Ljava/lang/String;",
        natives::native_string_split,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "hashCode",
        "()I",
        natives::native_string_hashcode,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "toString",
        "()Ljava/lang/String;",
        natives::native_string_tostring,
    );
    ...
    registry.natives_mut().register(
        ...
        "valueOf",
        "(I)Ljava/lang/String;",
        natives::native_string_value_of_int,
    );
    ...
    registry.natives_mut().register(
        ...
        "print",
        "(Ljava/lang/String;)V",
        natives::native_print_string,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "print",
        "(I)V",
        natives::native_print_int,
    );
    ...
    registry.natives_mut().register(
        ...
        "println",
        "(J)V",
        natives::native_println_long,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "println",
        "(F)V",
        natives::native_println_float,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "println",
        "(D)V",
        natives::native_println_double,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "println",
        "(Z)V",
        natives::native_println_boolean,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "println",
        "(C)V",
        natives::native_println_char,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "println",
        "(Ljava/lang/Object;)V",
        natives::native_println_object,
    );
    ...
    registry.natives_mut().register(
        ...
        "print",
        "(J)V",
        natives::native_print_long,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "print",
        "(F)V",
        natives::native_print_float,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "print",
        "(D)V",
        natives::native_print_double,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "print",
        "(Z)V",
        natives::native_print_boolean,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "print",
        "(C)V",
        natives::native_print_char,
    );
    registry.natives_mut().register(
        "java/io/PrintStream",
        "print",
        "(Ljava/lang/Object;)V",
        natives::native_print_object,
    );
    ...
    registry.natives_mut().register(
        ...
        "hashCode",
        "()I",
        natives::native_object_hashcode,
    );
    registry.natives_mut().register(
        "java/lang/Object",
        "toString",
        "()Ljava/lang/String;",
        natives::native_object_tostring,
    );
    registry.natives_mut().register(
        "java/lang/Object",
        "clone",
        "()Ljava/lang/Object;",
        natives::native_object_clone,
    );
    ...
    registry.natives_mut().register(
        ...
        "<init>",
        "()V",
        natives::native_thread_init,
    );
    registry.natives_mut().register(
        "java/lang/Thread",
        "<init>",
        "(Ljava/lang/Runnable;)V",
        natives::native_thread_init_runnable,
    );
    registry.natives_mut().register(
        "java/lang/Thread",
        "start",
        "()V",
        natives::native_thread_start,
    );
    registry.natives_mut().register(
        "java/lang/Thread",
        "join",
        "()V",
        natives::native_thread_join,
    );
    registry.natives_mut().register(
        "java/lang/Thread",
        "sleep",
        "(J)V",
        natives::native_thread_sleep,
    );
    ...
    registry.natives_mut().register(
        ...
        natives::native_throwable_add_suppressed,
    );
    ...
    registry.natives_mut().register(
        ...
        "<init>",
        "(Ljava/lang/String;I)V",
        natives::native_enum_init,
    );
    registry.natives_mut().register(
        "java/lang/Enum",
        "ordinal",
        "()I",
        natives::native_enum_ordinal,
    );
    registry.natives_mut().register(
        "java/lang/Enum",
        "name",
        "()Ljava/lang/String;",
        natives::native_enum_name,
    );
    registry.natives_mut().register(
        "java/lang/Enum",
        "valueOf",
        "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;",
        natives::native_enum_valueof,
    );
    ...
    registry.natives_mut().register(
        ...
        "parseInt",
        "(Ljava/lang/String;)I",
        natives::native_integer_parseint,
    );
    registry.natives_mut().register(
        "java/lang/Integer",
        "valueOf",
        "(I)Ljava/lang/Integer;",
        natives::native_integer_valueof,
    );
    registry.natives_mut().register(
        "java/lang/Integer",
        "intValue",
        "()I",
        natives::native_integer_intvalue,
    );
    registry.natives_mut().register(
        "java/lang/Integer",
        "toString",
        "(I)Ljava/lang/String;",
        natives::native_integer_tostring_static,
    );
    registry.natives_mut().register(
        "java/lang/Integer",
        "compareTo",
        "(Ljava/lang/Object;)I",
        natives::native_integer_compareto,
    );
    ...
    registry.natives_mut().register(
        ...
        "parseLong",
        "(Ljava/lang/String;)J",
        natives::native_long_parselong,
    );
    registry.natives_mut().register(
        "java/lang/Long",
        "valueOf",
        "(J)Ljava/lang/Long;",
        natives::native_long_valueof,
    );
    registry.natives_mut().register(
        "java/lang/Long",
        "longValue",
        "()J",
        natives::native_long_longvalue,
    );
    registry.natives_mut().register(
        "java/lang/Long",
        "toString",
        "(J)Ljava/lang/String;",
        natives::native_long_tostring_static,
    );
    registry.natives_mut().register(
        "java/lang/Long",
        "compareTo",
        "(Ljava/lang/Object;)I",
        natives::native_long_compareto,
    );
    ...
    registry.natives_mut().register(
        ...
        "parseDouble",
        "(Ljava/lang/String;)D",
        natives::native_double_parsedouble,
    );
    registry.natives_mut().register(
        "java/lang/Double",
        "valueOf",
        "(D)Ljava/lang/Double;",
        natives::native_double_valueof,
    );
    registry.natives_mut().register(
        "java/lang/Double",
        "doubleValue",
        "()D",
        natives::native_double_doublevalue,
    );
    registry.natives_mut().register(
        "java/lang/Double",
        "isNaN",
        "(D)Z",
        natives::native_double_isnan,
    );
    registry.natives_mut().register(
        "java/lang/Double",
        "compareTo",
        "(Ljava/lang/Object;)I",
        natives::native_double_compareto,
    );
    ...
    registry.natives_mut().register(
        ...
        "parseFloat",
        "(Ljava/lang/String;)F",
        natives::native_float_parsefloat,
    );
    ...
    registry.natives_mut().register(
        ...
        "parseBoolean",
        "(Ljava/lang/String;)Z",
        natives::native_boolean_parseboolean,
    );
    ...
    registry.natives_mut().register(
        ...
        "max",
        "(II)I",
        natives::native_math_max_int,
    );
    registry.natives_mut().register(
        "java/lang/Math",
        "min",
        "(II)I",
        natives::native_math_min_int,
    );
    registry.natives_mut().register(
        "java/lang/Math",
        "abs",
        "(I)I",
        natives::native_math_abs_int,
    );
    registry
        .natives_mut()
        .register("java/lang/Math", "sqrt", "(D)D", natives::native_math_sqrt);
    registry
        .natives_mut()
        .register("java/lang/Math", "pow", "(DD)D", natives::native_math_pow);
    registry.natives_mut().register(
        "java/lang/Math",
        "floor",
        "(D)D",
        natives::native_math_floor,
    );
    registry
        .natives_mut()
        .register("java/lang/Math", "ceil", "(D)D", natives::native_math_ceil);
    registry.natives_mut().register(
        "java/lang/Math",
        "round",
        "(D)J",
        natives::native_math_round_double,
    );
    registry.natives_mut().register(
        "java/lang/Math",
        "abs",
        "(J)J",
        natives::native_math_abs_long,
    );
    registry.natives_mut().register(
        "java/lang/Math",
        "abs",
        "(D)D",
        natives::native_math_abs_double,
    );
    registry.natives_mut().register(
        "java/lang/Math",
        "max",
        "(JJ)J",
        natives::native_math_max_long,
    );
    registry.natives_mut().register(
        "java/lang/Math",
        "min",
        "(JJ)J",
        natives::native_math_min_long,
    );
    registry.natives_mut().register(
        "java/lang/Math",
        "max",
        "(DD)D",
        natives::native_math_max_double,
    );
    registry.natives_mut().register(
        "java/lang/Math",
        "min",
        "(DD)D",
        natives::native_math_min_double,
    );
    ...
    registry.natives_mut().register(
        ...
        "valueOf",
        "(J)Ljava/lang/String;",
        natives::native_string_value_of_long,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "valueOf",
        "(D)Ljava/lang/String;",
        natives::native_string_value_of_double,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "valueOf",
        "(F)Ljava/lang/String;",
        natives::native_string_value_of_float,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "valueOf",
        "(Z)Ljava/lang/String;",
        natives::native_string_value_of_boolean,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "valueOf",
        "(C)Ljava/lang/String;",
        natives::native_string_value_of_char,
    );
    registry.natives_mut().register(
        "java/lang/String",
        "valueOf",
        "(Ljava/lang/Object;)Ljava/lang/String;",
        natives::native_string_value_of_object,
    );
    ...
    registry.natives_mut().register(
        ...
        natives::native_sb_append_string,
    );
    ...
    registry.natives_mut().register(
        ...
        natives::native_sb_append_double,
    );
    ...
    registry.natives_mut().register(
        ...
        natives::native_sb_append_float,
    );
    ...
    registry.natives_mut().register(
        ...
        natives::native_sb_append_boolean,
    );
    ...
    registry.natives_mut().register(
        ...
        "isWhitespace",
        "(C)Z",
        natives::native_char_is_whitespace,
    );
    ...
    registry.natives_mut().register(
        ...
        "isUpperCase",
        "(C)Z",
        natives::native_char_is_uppercase,
    );
    ...
    registry.natives_mut().register(
        ...
        "isLowerCase",
        "(C)Z",
        natives::native_char_is_lowercase,
    );
    ...
    registry.natives_mut().register(
        ...
        "toUpperCase",
        "(C)C",
        natives::native_char_to_uppercase,
    );
    ...
    registry.natives_mut().register(
        ...
        "toLowerCase",
        "(C)C",
        natives::native_char_to_lowercase,
    );
    ...
    registry.natives_mut().register(
        ...
        "isLetterOrDigit",
        "(C)Z",
        natives::native_char_is_letter_or_digit,
    );
    ...
    registry.natives_mut().register(
        ...
        "<init>",
        "()V",
        natives::native_arraylist_init,
    );
    registry.natives_mut().register(
        "java/util/ArrayList",
        "add",
        "(Ljava/lang/Object;)Z",
        natives::native_arraylist_add,
    );
    registry.natives_mut().register(
        "java/util/ArrayList",
        "get",
        "(I)Ljava/lang/Object;",
        natives::native_arraylist_get,
    );
    registry.natives_mut().register(
        "java/util/ArrayList",
        "size",
        "()I",
        natives::native_arraylist_size,
    );
    registry.natives_mut().register(
        "java/util/ArrayList",
        "iterator",
        "()Ljava/util/Iterator;",
        natives::native_arraylist_iterator,
    );
    registry.natives_mut().register_callback(
        "java/util/ArrayList",
        "sort",
        "(Ljava/util/Comparator;)V",
        natives::array_list_sort,
    );
    ...
    registry.natives_mut().register(
        ...
        "<init>",
        "()V",
        natives::native_arraylist_iter_init,
    );
    registry.natives_mut().register(
        "duke/util/ArrayListIterator",
        "hasNext",
        "()Z",
        natives::native_arraylist_iter_hasnext,
    );
    registry.natives_mut().register(
        "duke/util/ArrayListIterator",
        "next",
        "()Ljava/lang/Object;",
        natives::native_arraylist_iter_next,
    );
    ...
    registry.natives_mut().register(
        ...
        "fill",
        "([II)V",
        natives::native_arrays_fill_int,
    );
    registry.natives_mut().register(
        "java/util/Arrays",
        "fill",
        "([Ljava/lang/Object;Ljava/lang/Object;)V",
        natives::native_arrays_fill_object,
    );
    registry.natives_mut().register(
        "java/util/Arrays",
        "copyOf",
        "([II)[I",
        natives::native_arrays_copyof_int,
    );
    registry.natives_mut().register(
        "java/util/Arrays",
        "copyOf",
        "([Ljava/lang/Object;I)[Ljava/lang/Object;",
        natives::native_arrays_copyof_object,
    );
    registry.natives_mut().register(
        "java/util/Arrays",
        "sort",
        "([I)V",
        natives::native_arrays_sort_int,
    );
    ...
    registry.natives_mut().register(
        ...
        "<init>",
        "()V",
        natives::native_hashmap_init,
    );
    registry.natives_mut().register(
        "java/util/HashMap",
        "put",
        "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;",
        natives::native_hashmap_put,
    );
    registry.natives_mut().register(
        "java/util/HashMap",
        "get",
        "(Ljava/lang/Object;)Ljava/lang/Object;",
        natives::native_hashmap_get,
    );
    registry.natives_mut().register(
        "java/util/HashMap",
        "containsKey",
        "(Ljava/lang/Object;)Z",
        natives::native_hashmap_contains_key,
    );
    registry.natives_mut().register(
        "java/util/HashMap",
        "size",
        "()I",
        natives::native_hashmap_size,
    );
    registry.natives_mut().register(
        "java/util/HashMap",
        "remove",
        "(Ljava/lang/Object;)Ljava/lang/Object;",
        natives::native_hashmap_remove,
    );
    registry.natives_mut().register(
        "java/util/HashMap",
        "isEmpty",
        "()Z",
        natives::native_hashmap_is_empty,
    );
    registry.natives_mut().register(
        "java/util/HashMap",
        "getOrDefault",
        "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;",
        natives::native_hashmap_get_or_default,
    );
    ...
    registry.natives_mut().register(
        ...
        "<init>",
        "()V",
        natives::native_hashset_init,
    );
    registry.natives_mut().register(
        "java/util/HashSet",
        "add",
        "(Ljava/lang/Object;)Z",
        natives::native_hashset_add,
    );
    registry.natives_mut().register(
        "java/util/HashSet",
        "contains",
        "(Ljava/lang/Object;)Z",
        natives::native_hashset_contains,
    );
    registry.natives_mut().register(
        "java/util/HashSet",
        "remove",
        "(Ljava/lang/Object;)Z",
        natives::native_hashset_remove,
    );
    registry.natives_mut().register(
        "java/util/HashSet",
        "size",
        "()I",
        natives::native_hashset_size,
    );
    registry.natives_mut().register(
        "java/util/HashSet",
        "isEmpty",
        "()Z",
        natives::native_hashset_is_empty,
    );
    ...
    registry.natives_mut().register_callback(
        ...
        "sort",
        "(Ljava/util/List;)V",
        natives::native_collections_sort,
    );
    ...
    registry.natives_mut().register(
        ...
        "getName",
        "()Ljava/lang/String;",
        natives::native_zip_entry_get_name,
    );
    registry.natives_mut().register(
        "java/util/zip/ZipEntry",
        "getCompressedSize",
        "()J",
        natives::native_zip_entry_get_compressed_size,
    );
    registry.natives_mut().register(
        "java/util/zip/ZipEntry",
        "getSize",
        "()J",
        natives::native_zip_entry_get_size,
    );
    registry.natives_mut().register(
        "java/util/zip/ZipEntry",
        "getMethod",
        "()I",
        natives::native_zip_entry_get_method,
    );
    ...
    registry.natives_mut().register(
        ...
        "<init>",
        "(Ljava/lang/String;)V",
        natives::native_zip_file_init,
    );
    registry.natives_mut().register(
        "java/util/zip/ZipFile",
        "getEntry",
        "(Ljava/lang/String;)Ljava/util/zip/ZipEntry;",
        natives::native_zip_file_get_entry,
    );
    registry.natives_mut().register(
        "java/util/zip/ZipFile",
        "getInputStream",
        "(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;",
        natives::native_zip_file_get_input_stream,
    );
    registry.natives_mut().register(
        "java/util/zip/ZipFile",
        "close",
        "()V",
        natives::native_zip_file_close,
    );
    registry.natives_mut().register(
        "java/util/zip/ZipFile",
        "size",
        "()I",
        natives::native_zip_file_size,
    );
        ...
        match &instr {
            ...
            Instruction::New(cp_idx) => {
                ...
                if gc_allowed && heap.should_gc() {
                    let roots = natives::gather_roots(frame, call_stack, registry);
                    heap.collect(&roots);
                    natives::patch_forwarded_slots(frame, call_stack, registry, heap);
                }
            }
            ...
            Instruction::Invokedynamic(cp_idx) => {
                ...
                if bsm_class == "java/lang/invoke/StringConcatFactory" {
                    ...
                    let result = natives::execute_string_concat_recipe(
                        &recipe,
                        &dynamic_args,
                        &arg_types,
                        &constants,
...
fn resolve_thread_entry(
    ...
    let target_ref = match heap
        .get(thread_ref)?
        .fields
        .get(natives::THREAD_TARGET_SLOT)
    {
...
fn spawn_java_thread(
...
) -> VmResult<()> {
    {
        ...
        let already_started = matches!(
            thread.fields.get(natives::THREAD_ID_SLOT),
    ...
    let entry = {
        ...
        {
            let thread = shared_guard.heap.get_mut(thread_ref)?;
            thread.fields[natives::THREAD_ID_SLOT] = Slot::Int(thread_id);
        }
        let CompletionVm {
            registry,
            heap,
...
mod tests {
        ...
        ($($name:ident),* $(,)?) => {
            $(
                fn $name(
                    ...
                    super::natives::$name(args, heap, out, &mut NativeControl::default())
                }
            )*
        };
    }
    ...
    fn array_list_sort(
        ...
        super::natives::array_list_sort(args, heap, out, &mut NativeControl::default(), invoke)
    }
