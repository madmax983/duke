//! Standard library native implementations and bootstrapping.


use std::io::Write;
use duke_runtime::{Slot, VmError, VmResult};
use crate::{ClassContext, ClassRegistry, NativeControl, NativeThreadAction, FieldEntry, InvokeFn};
use crate::{format_java_double, format_java_float};
