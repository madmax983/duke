...
/// Bolt Optimization: Avoids O(N) heap allocations by seamlessly reusing the existing vector allocation in O(1) space instead of iterating and collecting chars, since Base64 output is guaranteed to be valid ASCII/UTF-8.
