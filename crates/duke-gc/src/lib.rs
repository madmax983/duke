...
impl Heap {
    ...
    ///
    /// # Panics
    /// Panics if the young generation index does not fit into `usize`.
    ...
    ///
    /// # Panics
    /// Panics if any collected young object reference index does not fit in `usize`.
    ...
    ///
    /// # Panics
    /// Panics if the forwarding reference's young index does not fit into `usize`.
