...
fn bump_coverage() {
    ...
    let _ = error::Error::CpIndexOutOfBounds { index: 0, pool_size: 0 };
    ...
    let _ = error::Error::AttributeLengthMismatch { declared: 0, consumed: 0 };
    let _ = error::Error::TruncatedAttribute { name: "test", expected: 0, got: 0 };
