...
**Blueprint:** Encapsulated the module. In `duke_classfile`, changed `pub mod signature` to `pub(crate) mod signature;`, eliminating the `signature` namespace from the public API entirely and enforcing the root-level re-exports.
