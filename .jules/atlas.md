...
**[Encapsulate Module Facades]
**Tangle:** The `duke_classfile` API exported an intermediate `signature` module (`pub mod signature`). This creates confusing, leaky abstractions and redundant paths.
**Blueprint:** Encapsulated the module by changing its visibility to `pub(crate)`. Re-exports at the crate root maintain the necessary public API.
