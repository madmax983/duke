...
## 2024-05-25 - [CLI Analysis Tools Documentation]
**Confusion:** The new suite of command-line analysis tools (like `audit`, `jar-diff`, `simulate`) were completely undocumented in the `README.md` and their source files lacked module-level documentation (`//!`) and function documentation (`///`).
**Clarification:** Updated the `README.md` to list and describe the new analysis features to make them discoverable. Added comprehensive documentation to `duke/src/audit.rs` including an executable doctest to explain what it does, why it exists, and how to run it.
