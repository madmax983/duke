...
## 2024-05-25 - [Intra-doc links and Layouts]
**Confusion:** Links to private items in public documentation caused `cargo doc` warnings, and bracketed text for layout descriptions (like `[0]`) triggered unresolved link warnings.
**Clarification:** Converted private intra-doc links to backticked code items and removed their definitions, and wrapped layout descriptions in backticks to prevent rustdoc from treating them as links.
